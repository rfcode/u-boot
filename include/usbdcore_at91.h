...
#ifndef __USBDCORE_AT91_H__
#define __USBDCORE_AT91_H__
...
#define     AT91_UDP_RXSETUP	(1 <<  2)	/* Setup packet received */
...
extern void udc_setup_ep(struct usb_device_instance *device, unsigned int ep, struct usb_endpoint_instance *endpoint);
extern void udc_irq (void);
extern int udc_vbus_active (void);
